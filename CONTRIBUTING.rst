...
Thank you for your help improving **e-sbae**!

**e-sbae** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **e-sbae** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/{{ YOUR USERNAME }}/eSBAE
   cd eSBAE
...
This will install the **e-sbae** library, together with two additional tools:
